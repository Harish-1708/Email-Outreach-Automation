...
def _is_reply_subject_match(msg_subject: str, original_subject: str) -> bool:
    ...
    accumulation some mail clients produce) followed by the exact
    original subject line, case-insensitive.
    ...
    <exact original subject>" from the exact lead's own email address
    ...
    return had_reply_prefix and stripped.strip().lower() == original_subject.strip().lower()
