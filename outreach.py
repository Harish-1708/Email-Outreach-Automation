...
def sync_campaign_to_asana(sheets: SheetsConnector, campaign_cfg: Dict, api_key: str,
                            default_assignee_email: Optional[str] = None) -> Dict:
...
def sync_campaign_to_tracker_sheet(sheets: SheetsConnector, campaign_cfg: Dict, tracker_ws,
                                    asana_manual_state_by_email: Optional[Dict[str, Dict]] = None) -> Dict:
...
def collect_asana_manual_state_for_leads(sheets: SheetsConnector, campaign_cfg: Dict, api_key: str) -> Dict[str, Dict]:
    ...
    if asana_enabled:
        if not api_key:
            ...
            result = sync_campaign_to_asana(sheets, campaign_cfg, api_key,
                                             default_assignee_email=default_assignee_email)
        ...
        if tracker_enabled:
            if not tracker_sheet_id or not tracker_worksheet_name:
                ...
                try:
                    ...
                    asana_manual_state = collect_asana_manual_state_for_leads(sheets, campaign_cfg, asana_api_key)
                    result = sync_campaign_to_tracker_sheet(sheets, campaign_cfg, tracker_ws,
                                                             asana_manual_state_by_email=asana_manual_state)
