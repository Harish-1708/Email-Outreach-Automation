...
def test_find_tracker_row_for_lead_ambiguous_name_match_never_guesses():
    """The actual safety property this whole design leans on — a name
    matching MORE than one row in a 3000+ row sheet must never be
    silently resolved by picking one; it has to be reported instead."""
